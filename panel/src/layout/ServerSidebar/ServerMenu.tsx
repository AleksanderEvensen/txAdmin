...
import { BoxIcon, ChevronRightSquareIcon, DnaIcon, EyeIcon, FileEditIcon, GitGraphIcon, HourglassIcon, LayoutDashboardIcon } from 'lucide-react';
    ...
    return <div className='relative'>
        ...
        <div className={cn(serverConfigPendingStep && 'opacity-0 pointer-events-none')}>
            ...
            <div className="space-y-1 select-none">
                ...
                <MenuNavLink href="/server/version-control" disabled={!hasPerm('server.version-control')}>
                    <GitGraphIcon className="mr-2 h-4 w-4" />Version Control
                </MenuNavLink>
